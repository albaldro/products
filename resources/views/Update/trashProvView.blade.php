...
<html>
    ...
    @foreach($providers as $provider)
        ...
        <div class="flex justify-center m-10">
            <form method="GET" class="border-2 rounded-lg border-black w-64 bg-cyan-200 " action="{{ route('trashProvForm') }}">

                 <h1 class="text-4xl font-bold mb-5 ml-3 mr-3 ">Details</h1>

                    <p class="mb-2 text-left ml-5">
                        ID: <br>
                        <input class="mbr-5 w-52" type="text" value="{{ $provider['provider']['id'] }}" readonly name="id">
                    </p>

                    <p class="mb-2 text-left ml-5">
                        Name: <br>
                        <input class="mbr-5 w-52" type="text" value="{{ $provider['provider']['name'] }}" readonly name="name">
                    </p>
